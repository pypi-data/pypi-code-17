...
class Trip:
    ...
    def update_trip_times(trips_df, MSA_RESULTS):
        ...
        print trips_df[[Trip.STOPTIMES_COLUMN_TRAVEL_TIME_SEC, Trip.STOPTIMES_COLUMN_TRAVEL_TIME, Trip.STOPTIMES_COLUMN_ORIGINAL_TRAVEL_TIME, "accel_secs", "decel_secs"]]
